  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          _section('No financial advice', 'The GIGA Kaspa Mining app is for entertainment and educational purposes only. Nothing in the app constitutes financial, investment, or legal advice. You should not rely on the app for any financial decisions.'),
